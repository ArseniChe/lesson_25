...
async function loadWeather() {
    ...
    const{latitude,longitude,city}=obj
    ...
    console.log("Our weather", getWeatherDesc(weathercode))

    info.textContent="Our weather"+getWeatherDesc(weathercode)
    place.textContent=`${city}`
    temperatureItem.textContent=temperature+" °C"
